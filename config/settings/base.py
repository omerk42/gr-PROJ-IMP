...
MIGRATION_MODULES = {"sites": "zaid.contrib.sites.migrations"}
...
LOGIN_REDIRECT_URL = "/" # change to chek
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "zaid.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""omer khan & sultan fahad""", "zaid@zaid.test")]
...
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "zaid.users.forms.UserSocialSignupForm"}
